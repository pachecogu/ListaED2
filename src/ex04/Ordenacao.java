...
//    }
//    
//    public static void MergeSortNome(ArrayList<Aluno> lista, int inicio, int fim) {
//        int meio;
//        fim = lista.size();
//        
//        if (inicio < fim) {
...
//    }
//
//    public static void intercala(ArrayList<Aluno> lista, int inicio, int fim, int meio) {
...
//    
//    //###################################
//        public static void MergeSortSalario(ArrayList<Aluno> lista, int inicio, int fim) {
//        int meio;
//        fim = lista.size();
//        
//        if (inicio < fim) {
...
//    }
//
//    public static void intercalaSalario(ArrayList<Aluno> lista, int inicio, int fim, int meio) {
//        int poslivre, inicio_vetor1, inicio_vetor2, i;
//        ArrayList<Aluno> aux = new ArrayList<>();
//        inicio_vetor1 = inicio;
//        inicio_vetor2 = meio + 1;
