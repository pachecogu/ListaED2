...
import static ex04.Busca.NumeroDeComparacoesBuscaBinaria;
import static ex04.Busca.NumeroDeComparacoesBuscaSequencial;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (continua == 1 && count < 12) {
            ...
            Aluno produto = new Aluno(cod, nome, preco);
